...
int main() {
    ...
    //
    // For NOR, replace above training outputs with:
    // int training_outputs[4] = {1, 0, 0, 0};
    //
    // For A > B, replace the above training outputs with:
    // int training_outputs[4] = {0, 0, 1, 0};
    //
    // For A >= B, replace the above training outputs with:
    // int training_outputs[4] = {1, 0, 1, 1};
    ...
    // Testing
    printf("Testing the trained perceptron for AND:\n");
    int correct = 0;
    for (int i = 0; i < 4; i++) {
